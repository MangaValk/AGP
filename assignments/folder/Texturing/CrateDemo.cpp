...
: D3DApp(hInstance), mBoxVB(0), mBoxIB(0), mDiffuseMapSRV(0), mDiffuseMapSRV2(0), mEyePosW(0.0f, 0.0f, 0.0f),
...
bool CrateApp::Init()
{
	...
	HR(D3DX11CreateShaderResourceViewFromFile(md3dDevice,
		L"Textures/Texture2.bmp", 0, 0, &mDiffuseMapSRV, 0));



	HR(D3DX11CreateShaderResourceViewFromFile(md3dDevice,
		L"Textures/Texture3.png", 0, 0, &mDiffuseMapSRV2, 0));
...
void CrateApp::BuildGeometryBuffers()
{
	...
	geoGen.CreateBox(0.5f, 1.0f, 0.1f, box);
	//geoGen.CreateCylinder(1, 1, 5, 100, 1, box);
	...
	XMFLOAT2 a[] = { XMFLOAT2(0.25f, 0.3f),
					 XMFLOAT2(0.25f, 0.6f),
					 XMFLOAT2(0.5f, 0.6f),
					 XMFLOAT2(0.5f, 0.3f),
...
//
//		vertices[k].Tex   = XMFLOAT2(box.Vertices[i].Position.x + box.Vertices[i].Position.z, box.Vertices[i].Position.y);
//	}
//
//
//    D3D11_BUFFER_DESC vbd;
