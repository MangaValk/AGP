...
//	mCenterSphereMat.Reflect  = XMFLOAT4(0.8f, 0.8f, 0.8f, 1.0f);
	mCenterSphereMat.Reflect  = XMFLOAT4(temp1, temp1, temp1, 1.0f);
}
...
void DynamicCubeMapApp::OnMouseMove(WPARAM btnState, int x, int y)
{
	...
	if ((btnState & MK_MBUTTON) != 0)
	{
		...
		mCenterSphereMat.Reflect = XMFLOAT4(temp1, temp1, temp1, 1.0f);
		mCenterSphereMat.Ambient = XMFLOAT4(temp1, temp1, temp1, 1.0f);
		mCenterSphereMat.Diffuse = XMFLOAT4(temp1, temp1, temp1, 1.0f);
		mCenterSphereMat.Specular = XMFLOAT4(temp1, temp1, temp1, 1.0f);
	}
